...
figure(1)
[s1, h1] = silhouette(data(:, 1:3000), idx1, 'sqeuclidean');
...
figure(2)
[s2, h2] = silhouette(data(:, 1:3000), idx2, 'cosine');
...
figure(3)
[s3, h3] = silhouette(data(:, 1:3000), idx3, 'correlation');
...
figure(4)
[s4, h4] = silhouette(data(:, 1:3000), idx4, 'cityblock');
...
[coeff, score]= pca(data)    %% pca exists also in octave
...
[idx, centers] = kmeans(data, 3, 'Replicates', 5);
